...
export SYNC_REPO_URL="https://github.com/4IceG/luci-app-sms-tool-js.git"
export SYNC_REMOTE_PATH="/luci-app-sms-tool-js"
export SYNC_DEST_DIR="package/luci-app-sms-tool-js"
